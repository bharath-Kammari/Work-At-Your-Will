...
public class Job {
    ...
    public Job(String requestFrom, String requestTo, String serviceId, Date date,  boolean accepted,String s_name, String s_cost, String s_desc, String s_rating, String bookings_month, String business_name,String est,String orderStatus) {
        this.requestFrom = requestFrom;
        estimateDelivery=est;
