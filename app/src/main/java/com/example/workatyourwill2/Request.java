...
public class Request {
    ...
    public Request(String requestFrom, String requestTo, String serviceId, Date date,  boolean accepted,String s_name, String s_cost, String s_desc, String s_rating, String bookings_month, String business_name) {
