...
public class Service {
    ...
    public int s_cost;
    public double s_rating=0;
    public String worker_id;
    public int s_bookings_per_month=0;
    ...
    public Service(String category, Date date_added, String s_name, String s_desc, int s_cost, String worker_id) {
        this.category=category;
        this.date_added=date_added;
        this.s_name = s_name;
        this.s_desc = s_desc;
